    ...
    <div role="main" class="y-margintop">
        <div class="y-wdlst">
            <ul data-role="listview" class="y-wdlsts">
                ...
                <li data-icon="false"><a href="{{ u('UserCenter/address') }}" data-ajax="false"><img src="{{ asset('wap/community/client/images/ico/sz7.png') }}" /><span>收货地址@if($user)({{$counts['addressCount']}})@endif</span><i class="x-rightico"></i><!--<i class="yy"></i>--></a>
