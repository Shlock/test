...
@section('show_top')
    <div data-role="header" data-position="fixed" class="x-header">
        ...
        <a class="x-sjr ui-btn-right" href="{{ u('Seller/search') }}"><img src="{{ asset('wap/images/ico/search.png') }}" width="23" /></a>
    </div>
@stop
@section('css')
    <style>
        ...
        jQuery(function($){
            ...
            $.computeDistanceBegin = function () {
                ...
                if (isSortPosition) {
                    ...
                    window.location.href = "{!! u('Seller/index')!!}?" + $.param(pageArgs);
                    return;
                }
