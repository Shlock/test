...
<head>
    <meta charset="UTF-8">
    <title>@section('title'){{$site_config['site_title']}}@show</title>    
    ...
    <link rel="stylesheet" href="{{ asset('wap/community/client/css/jquery.mobile.custom.structure.min.css') }}">
    <link rel="stylesheet" href="{{ asset('wap/community/client/css/jquery.mobile.icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('wap/community/client/css/theme-a.min.css') }}">
    ...
    <script src="{{ asset('wap/community/client/js/jquery.mobile.custom.min.js') }}"></script>    
    <script src="{{ asset('wap/community/client/js/TouchSlide.1.1.js') }}"></script>
    <script src="{{ asset('wap/community/base.js') }}?{{ TPL_VERSION }}"></script>
    ...
    <div>
        ...
        @section('show_top')
            <div data-role="header" data-position="fixed" class="x-header">
                ...
                <a href="@if(!empty($nav_back_url)) {{ $nav_back_url }} @else javascript:history.back(-1); @endif"  class="x-sjr ui-btns-right">
                    <i class="x-serico"></i>
                </a>
            </div>
        @show
