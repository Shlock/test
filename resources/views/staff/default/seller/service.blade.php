...
@section('show_top')
    <header class="bar bar-nav">
        ...
        <a href="#" onclick="JumpURL('{{u('Seller/addnew',['type' => 2,'tradeId'=>(int)Input::get('id')])}}','#seller_addnew_view',2)" class="button external pageloding button-link button-nav f_r" data-popup=".popup-about">
            添加服务
        </a>
