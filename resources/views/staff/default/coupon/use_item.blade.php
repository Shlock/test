@foreach($list as $val)
<li @if($val['type'] == 'offset') class="y-xcq2" @else class="y-xcq1" @endif onclick="window.location.href='{{ u('Order/order',['proId'=>$val['id'],'cartIds'=>$args['cartIds'],'addressId'=>$args['addressId']]) }}'">
	<div class="y-xcql">
		<p class="y-xcqmoney">
            @if($val['type'] == 'money')
