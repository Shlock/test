...
class SellerService extends \YiZan\Services\SellerService 
{
     ...
     */
    public static function getStaffList($cityId, $page, $order, $sort, $keywords = '', $appointTime = '', $mapPoint = '', $appointMapPoint = '') {
    ...
    public static function getStaff($staffId, $userId = 0) {
        if ((int)$userId > 0) {
            return SellerStaff::with('collect', 'extend','seller')->find($staffId);
        } else {
