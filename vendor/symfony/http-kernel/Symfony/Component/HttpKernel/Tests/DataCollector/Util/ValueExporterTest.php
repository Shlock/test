...
class ValueExporterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $dateTime = new \DateTime('2014-06-10 07:35:40', new \DateTimeZone('Asia/Shanghai'));
    ...
    public function testDateTimeImmutable()
    {
        ...
        $dateTime = new \DateTimeImmutable('2014-06-10 07:35:40', new \DateTimeZone('Asia/Shanghai'));
